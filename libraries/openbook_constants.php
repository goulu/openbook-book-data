...
define('OB_OPTION_TEMPLATE1_VAL', '<div style="float:left;padding-right:10px;padding-bottom:10px;">[OB_COVER_MEDIUM]</div><div style="font-size:18px;font-weight:bold;">[OB_TITLE]</div><div style="font-size:14px;">[OB_AUTHORS]; [OB_PUBLISHER] [OB_PUBLISHYEAR]</div><div style="font-size:10px;">[OB_LINK_WORLDCAT][OB_DOT][OB_READONLINE][OB_DOT][OB_LINK_LIBRARYTHING][OB_DOT][OB_LINK_GOOGLEBOOKS][OB_DOT][OB_LINK_BOOKFINDER]</div>[OB_COINS]<p>');

define('OB_OPTION_TEMPLATE2_NAME', 'openbook_template2');
define('OB_OPTION_TEMPLATE2_VAL', '<div style="float:left;padding-right:5px;padding-bottom:5px;">[OB_COVER_SMALL]</div><div style="font-weight:bold">[OB_TITLE]; [OL_AUTHORFIRST]</div>[OB_LINK_WORLDCAT][OB_COINS]');

define('OB_OPTION_TEMPLATE3_NAME', 'openbook_template3');
define('OB_OPTION_TEMPLATE3_VAL', '<div align="center">[OB_COVER_LARGE]<div style="font-size:10px;">[OB_LINK_WORLDCAT][OB_DOT][OB_READONLINE][OB_DOT][OB_LINK_LIBRARYTHING][OB_DOT][OB_LINK_GOOGLEBOOKS][OB_DOT][OB_LINK_BOOKFINDER]</div></div>[OB_COINS]<p>');
...
define('OB_OPTION_LIBRARY_COVERSERVER_NAME', 'openbook_openlibrary_coverserver');
define('OB_OPTION_LIBRARY_COVERSERVER_VAL', 'http://covers.openlibrary.org');
