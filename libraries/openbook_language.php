...
define('OB_BOOKNUMBERREQUIRED_LANG', __('OpenBook requires at least at book number, e.g., ISBN or Open Library key'));
define('OB_INVALIDTEMPLATENUMBER_LANG', __('Invalid template or template number. Correct the template, or enter a template number of 1, 2 or 3. If this does not work, click \'Reset to installation values\' in Settings.'));
...
define('OB_OPTIONS_LIBRARY_COVERSERVER_DETAIL_LANG', __('Use the default value for Open Library or enter the cover server for your local installation'));
...
define('OB_OPTIONS_SHOWERRORS_DETAIL_LANG', __('When this box is checked, OpenBook displays detailed information if an error occurs. Useful for diagnosing problems.'));
...
define('OB_DISPLAY_READONLINE_TITLE_LANG', __('Read this work online at Open Library'));
define('OB_DISPLAY_WORLDCAT_LANG', __('WorldCat'));
define('OB_DISPLAY_WORLDCAT_TITLE_LANG', __('Find in a library using WorldCat'));
define('OB_DISPLAY_LIBRARYTHING_LANG', __('LibraryThing'));
define('OB_DISPLAY_LIBRARYTHING_TITLE_LANG', __('Connect with other readers at LibraryThing'));
define('OB_DISPLAY_GOOGLEBOOKS_LANG', __('Google Books'));
define('OB_DISPLAY_GOOGLEBOOKS_TITLE_LANG', __('Search for this title in Google Books'));
define('OB_DISPLAY_BOOKFINDER_LANG', __('BookFinder'));
define('OB_DISPLAY_BOOKFINDER_TITLE_LANG', __('Search for the best price'));
